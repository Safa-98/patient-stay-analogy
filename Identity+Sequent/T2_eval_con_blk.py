...
def evaluate_classifier(filename, nb_analogies, rd_seed):
    ...
    path_models = f"mimic_blk_T2/classif_cnn/classification_1_con_40e.pth"
    ...
    torch.save({"valid": mean(accuracy_true), "invalid": mean(accuracy_false)}, f"mimic_blk_T2/eval_cnn/evaluation_correct_{rd_seed}_con_40e.pth")
